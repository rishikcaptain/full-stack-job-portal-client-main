            ...
            <Wrapper ref={heroRef}>
                <div className="hero-content">
                    <div className="text-content">
                        <h1>
                            Get Your <span className="fancy">Dream HandyMan Job </span> 
                            Today!
                        </h1>
                        <p>
                        Looking for a job that fits your skills in plumbing, carpentry, or general handyman services? 
                            Join HandyLinker, where jobs are tailored for skilled tradespeople just like you. Explore hundreds 
                            of job opportunities in your area and land the perfect role.
                        </p>
