  ...
  return (
    ...
    <div className= 'max-w-screen-2x1 container mx-auto xl:px-24 px-4'>
      ...
      <div className='mt-5'>
        ...
        <button onClick={handleSearch}className='bg-[#32c888] text-white font-semibold px-8 py-2 rounded-sm mb-4'>Search</button>
        </div>
        </div>
        ...
        <div className='grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-12 my-12 items-center'>
        {
            ...
            <p className= 'my-2 font-medium text-[#32c888] text-lg'> {data.salary}</p>
            <div className='flex flex-wrap gap-4'>
            <a href="/all-jobs" className='underline'>{data.status}</a> 
